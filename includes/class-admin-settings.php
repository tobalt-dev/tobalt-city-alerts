...
class Admin_Settings {
    ...
    public function sanitize_settings( $input ) {
        ...
        $sanitized['injection_mode']    = in_array( $input['injection_mode'] ?? '', [ 'auto', 'shortcode', 'menu' ], true ) ? $input['injection_mode'] : 'auto';
    ...
    /**
     * Render display mode with menu selector.
     */
    public function render_display_mode() {
        ...
        <fieldset>
            ...
            <label>
                ...
                <?php esc_html_e( 'Tik trumpuoju kodu', 'tobalt-city-alerts' ); ?>
            </label><br>
            <label>
                <input type="radio" name="<?php echo esc_attr( $this->option_name . '[injection_mode]' ); ?>" value="menu" <?php checked( $mode, 'menu' ); ?>>
                <?php esc_html_e( 'Meniu', 'tobalt-city-alerts' ); ?>
                <select name="<?php echo esc_attr( $this->option_name . '[menu_location]' ); ?>" style="margin-left: 5px;">
                    <option value=""><?php esc_html_e( '— Pasirinkite meniu —', 'tobalt-city-alerts' ); ?></option>
                    <?php foreach ( $locations as $slug => $name ) : ?>
                        <option value="<?php echo esc_attr( $slug ); ?>" <?php selected( $menu_location, $slug ); ?>><?php echo esc_html( $name ); ?></option>
                    <?php endforeach; ?>
                </select>
            </label>
        </fieldset>
